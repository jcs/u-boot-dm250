...
typedef enum UART_ch {
	...
	UART_CH3,
	UART_CH4,
#elif defined(CONFIG_ROCKCHIP_RK3036) || defined(CONFIG_ROCKCHIP_RK3126) || defined(CONFIG_ROCKCHIP_RK3128)
	UART_CH0,
	UART_CH1,
	UART_CH2,
#else
 ...
 */
#define UART_CLOCK_FREQ		24000000 /* CONFIG_SYS_CLK_FREQ_CRYSTAL */
